...
# Severson 2019 Table S2 'Full' model — 5 Discharge features + 8 paper-aligned
# extras (6 thermal/charge/late-fade + 2 internal-resistance from the per-cell
# summary group, added in Plan C+ when we enabled the previously-skipped
# v7.3 .mat ``summary`` extraction). Total: 13 columns.
